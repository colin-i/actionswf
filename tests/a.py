...
if len(sys.argv)==1:
	...
	f=actionswf.flagss.xxu|actionswf.flag.titles|actionswf.flag.no_metadata_version
print("%x" % f)
...
actionswf.actionsf(actionswf.Ref(buffer),actionswf.Ref(size),format,1,b'a')
actionswf.actionsf(actionswf.Ref(buffer),actionswf.Ref(size),"var a=%u+%u",[1,2])
